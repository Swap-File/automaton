...
void leds_update(struct led_struct* led_data) {
  ...
  for (int i = 0; i < 15; i++) {
    ...
    pixels.setPixelColor(15 + i, pixels.Color(led_data->x_leds[i].r, led_data->x_leds[i].g, led_data->x_leds[i].b));
    pixels.setPixelColor(30 + i, pixels.Color(led_data->x_leds[i].r, led_data->x_leds[i].g, led_data->x_leds[i].b));
    pixels.setPixelColor(45 + i, pixels.Color(led_data->x_leds[i].r, led_data->x_leds[i].g, led_data->x_leds[i].b));
  }
